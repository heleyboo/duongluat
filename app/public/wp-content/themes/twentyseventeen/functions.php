...
function register_theme_setting_items($items) {
    $items[] = array (
        ...
        'items' => array(
            array(
                'header' => 'My test option header',
                'options' => array (
                    array(
                        "name"	=> __( 'Disable me', 'beautyspa' ),
                        "id"	=> "disable_me",
                        "type"	=> InputType::TYPE_CHECKBOX
                    ),
                    array(
                        "name"		=> __( 'Test my option', 'beautyspa' ),
                        "id"		=> "time_option",
                        "type"		=> InputType::TYPE_SELECT,
                        "options"	=> array(
                            "traditional"	=> __( 'Traditional', 'beautyspa' ) ,
                            "modern"		=> __( 'Time Ago Format', 'beautyspa' ),
                            "none"			=> __( 'Disable all', 'beautyspa' )
                        )
                    ),
                    array(
                        "name"	=> __( 'Blocks Titles', 'beautyspa' ),
                        "id"	=> "my_typo",
                        "type"	=> InputType::TYPE_TYPO,
                    ),
                    array(
                        "name"	=> __( 'Test slider', 'beautyspa' ),
                        "id"	=> "my_slider",
                        "type"	=> InputType::TYPE_SLIDER,
                        "min"   => '10',
                        "max"   => '100',
                        "unit"  => 'Cm',
                        "default" => '12'
            ...
            array(
                ...
                'options' => array (
                    array(
                        ...
                        "options"	=> array(
                            "boxed"	=> get_template_directory_uri() . '/spa/images/boxed-all.png' ,
                            "full"	=> get_template_directory_uri() . '/spa/images/full.png',
                        ),
                        "image_value" => true,
                    ),
                )
